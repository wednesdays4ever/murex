...
def captain_i():
    print """
    The Captain sighs at your apology."""
    sleep(2)
    print """
    ...
    sleep(6)
    print """
    He sighs again. Your sympathy for this sad man 
    ...
    sleep(3)
    print """
    You thumb the edges of the thick envelope 
...
def captain_ii():
    ...
    you hear the sad and ugly captain call as 
    you run to the other side of the ship.
    ...
    You've read it over and over so many times, 
    but still, nothing makes much sense. \n """
    sleep(4)
    print """
...
def read_letteri():
    print """
    You can't help but open the well worn envelope one more time 
    before you dock. \n """
    sleep(2)
    print """
...
def mother_story():
    print """
    Your mother would only speak about her grandfather Taymor 
...
def wait_dock():
    print """
    You stare at the island as the ship approaches.
...
def path_from_dock():
    ...
    removed from the stone walls and hugging the rocky shore.
...
def door_with_no_knob():
    print """
    What appeared to be a door from a distance has no handle.
...
def push_or_pull_door():
    print """
    The giant eye springs open, impossibly.
...
def default_door():
    print """
    That did not seem to work. You remain locked out 
    and unenlightened."""
...
def door_eye_other():
    print """
    IF THIS IS SOME SORT OF JOKE IT IS UNACCEPTABLE.
...
def door_eye_attempt_enter():
    print """
    IT IS TRUE, YOUR BLOOD SMELLS PURE, 
...
def door_eye_not_chosen():
    print """
    I DO NOT WASTE TIME WITH THOSE WHO DO NOT WALK OUR PATH.
...
def path_left():
    print """
    The sand and rocks near the shore give way almost immediately 
...
def forest_enter():
    print """
    Dense and overgrown, it becomes harder and harder to follow the path.
    ...
    You cannot remember its title now, 
    but it was narrated by a cheerful, British voice, 
...
def forest_ruins():
    print """
    Moments after it felt as though the path would end in overgrowth, 
    it breaks open into a large, man-made clearing.\n
    A series of platforms and huts, 
    elevated in the trees and strung together by rope bridges, 
...
def tree_house():
    print """
    This is not at all what you were expecting 
    from the disarray in the clearing.
...
def tree_house_inspect():
    ...
    on the wall next to the opposite door
...
def open_diary():
    print """
    As soon as you open the cover, dust and ash drift out from between musty, 
...
def read_diary ():
    ...
    print """
    Most of the pages have stuck together, 
...
def discard_diary ():
    print """
    Your great grand-grandfather's initials weren't GL anyway.
    You're here for one reason and everything else is distraction."""

def rope_bridge():
    print """
    The door at the other side of the study opens straight onto a rope bridge.
...
def no_bridge():
    print """
    You turn back into the sad, smelly little room.
    The ladder down and the door to the bridge are the only paths out."""

def cross_bridge():
    print """
    The bridge swings wildly and forces you to take slow, careful steps.
    ...
    print """
    Continue on? Or return to the forest?"""
...
def ladder_down():
    ...
    A path leads back in what you believe 
...
def path_back():
    print """
    This path winds back through the trees. 
...
def gl_threaten():
    print """
    He laughs before responding to your threat.
...
def gl_taymor():
    print """
    YOU HAVE THE EYES OF THE MAN WHO TOOK IT ALL AWAY. 
...
def gl_diary_show():
    print """
    I DON'T KNOW WHAT YOU THINK YOU'VE LEARNED.
...
def gl_end_me():
    print """
    HORRIBLE THINGS I'VE BEEN MADE TO WITNESS.
...
def gl_dead():
    print """
    His life leaves its broken vessel easily.
...
def gl_no_kill_leave():
    print """
    The man is crazed and willing to kill,
...
def gl_no_kill_stay():
    print """
    You have faltered as an investigator,
